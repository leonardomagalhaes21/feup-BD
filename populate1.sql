...
INSERT INTO Veiculo (matricula, ano, condicao, garantia, modelo) VALUES
    ('AT-09-01', 1990, 'Usado', 12, 'Ferrari Testarossa'),
    ('LB-02-42', 1985, 'Usado', 12, 'Porsche 911 Turbo'),
    ('PC-97-67', 1980, 'Usado', 12, 'Lamborghini Countach'),
    ('LD-67-99', 1978, 'Usado', 12, 'Chevrolet Corvette'),
    ('ER-04-03', 1982, 'Usado', 12, 'Jaguar XJS'),
    ('FN-87-37', 1975, 'Usado', 12, 'Mercedes-Benz 450SL'),
    ('GM-99-62', 1988, 'Usado', 12, 'Aston Martin V8 Vantage'),
    ('ZH-80-08', 1970, 'Usado', 12, 'Rolls-Royce Silver Shadow'),
    ('WI-00-09', 1989, 'Usado', 12, 'Ferrari 328 GTS'),
    ('LJ-10-38', 1987, 'Usado', 12, 'Porsche 944 Turbo'),
    ('DK-10-79', 1984, 'Usado', 12, 'Lamborghini Jalpa'),
    ('KL-78-12', 1979, 'Usado', 12, 'Chevrolet Camaro Z/28'),
    ('OM-12-33', 1986, 'Usado', 12, 'Jaguar XJ6'),
    ('NW-44-31', 1976, 'Usado', 12, 'Mercedes-Benz 300D'),
    ('OO-46-64', 1981, 'Usado', 12, 'Aston Martin Lagonda'),
    ('PH-01-84', 1973, 'Usado', 12, 'Rolls-Royce Corniche'),
    ('QY-59-49', 1983, 'Usado', 12, 'Ferrari Mondial'),
    ('RA-55-34', 1972, 'Usado', 12, 'Porsche 911 Carrera RS'),
    ('SJ-61-11', 1977, 'Usado', 12, 'Lamborghini Urraco'),
    ('TF-04-14', 1984, 'Usado', 12, 'Chevrolet Monte Carlo'),
    ('AB-89-80', 1940, 'Usado', 12, 'Ferrari 125 S'),
    ('BM-11-83', 1938, 'Usado', 12, 'Porsche Type 64'),
    ('CD-19-86', 1936, 'Usado', 12, 'Lamborghini 5-95 Zagato'),
    ('DO-56-89', 1937, 'Usado', 12, 'Chevrolet Series AA Capitol'),
    ('EF-36-92', 1942, 'Usado', 12, 'Jaguar SS 1'),
    ('GE-83-98', 1948, 'Usado', 12, 'Aston Martin Coal Scuttle'),
    ('HX-33-00', 1946, 'Usado', 12, 'Rolls-Royce Silver Ghost'),
    ('IY-75-02', 1949, 'Usado', 12, 'Ferrari Tipo 166'),
    ('JA-66-05', 1952, 'Usado', 12, 'Porsche Type 27'),
    ('KL-97-08', 1955, 'Usado', 12, 'Lamborghini Cheetah'),
    ('LM-78-11', 1958, 'Usado', 12, 'Chevrolet Series C Classic Six'),
    ('MN-19-14', 1961, 'Usado', 12, 'Jaguar Swallow Sidecar'),
    ...
    ('JS-20-59', 1982, 'Usado', 12, 'Chevrolet Series F'),
    ...
    ('92-34-SL', 1992, 'Usado', 18, 'Ford Fiesta'),
    ('99-45-ZW', 1999, 'Usado', 15, 'Chevrolet Corsa'),
    ('05-56-MK', 2005, 'Usado', 24, 'Toyota Corolla'),
    ('98-67-HY', 1998, 'Usado', 12, 'Honda Civic'),
    ('93-78-RF', 1993, 'Usado', 12, 'Volkswagen Golf'),
    ('94-89-AA', 1994, 'Usado', 24, 'Mercedes-Benz C-Class'), 
    ('22-CR-13', 2020, 'Novo', 24, 'Toyota Corolla'),
    ('08-WS-16', 2008, 'Usado', 12, 'Honda Civic'),
    ('18-IT-19', 2018, 'Semi-Novo', 18, 'Mercedes-Benz E-Class'),
    ('09-UU-20', 2009, 'Usado', 12, 'Chevrolet Malibu'),
    ('14-XV-18', 2014, 'Semi-Novo', 15, 'BMW X5'),
    ('16-LW-11', 2016, 'Semi-Novo', 18, 'Ford Focus'),
    ('07-NX-09', 2007, 'Usado', 12, 'Nissan Altima'),
    ('21-WY-17', 2021, 'Novo', 24, 'Audi Q5'),
    ('10-AZ-14', 2010, 'Usado', 12, 'Toyota Prius'),
    ('11-HJ-06', 2011, 'Usado', 12, 'Audi A3'),
    ('15-MB-08', 2015, 'Semi-Novo', 24, 'Lexus RX'),
    ('20-CB-16', 2020, 'Novo', 24, 'Tesla Model 3'),
    ('19-DD-17', 2019, 'Semi-Novo', 18, 'Honda Accord'),
    ('13-PX-14', 2013, 'Usado', 12, 'Volkswagen Golf'),
    ('12-FA-10', 2012, 'Usado', 12, 'Mercedes-Benz C-Class'),
    ('05-GO-19', 2005, 'Usado', 15, 'Toyota Camry'),
    ('17-HU-15', 2017, 'Semi-Novo', 18, 'BMW 320i'),
    ('06-IQ-12', 2006, 'Usado', 12, 'Chevrolet Corsa'),
    ('16-JJ-08', 2016, 'Semi-Novo', 24, 'Audi A3'),
    ('18-KL-10', 2018, 'Semi-Novo', 18, 'Toyota Corolla'), 
    ('WD-01-AD', 2020, 'Novo', 24, 'Tesla Model 3'),
    ('QP-00-KD', 2021, 'Novo', 24, 'BMW X5'),
    ('VM-08-VS', 2022, 'Semi-Novo', 18, 'Audi Q5'),
    ('TW-41-FS', 2023, 'Semi-Novo', 18, 'Mercedes-Benz E-Class'),
    ('IX-55-KF', 2020, 'Novo', 24, 'Lexus RX'),
    ('UG-06-KF', 2021, 'Novo', 24, 'Toyota Camry'),
    ('OH-89-PC', 2022, 'Semi-Novo', 18, 'Honda Accord'),
    ('PI-78-ME', 2023, 'Semi-Novo', 18, 'Chevrolet Malibu'),
    ('FJ-06-UN', 2020, 'Semi-Novo', 24, 'Nissan Altima'),
    ('YK-19-MF', 2021, 'Novo', 24, 'Ford Focus'),
    ('FL-11-LS', 2022, 'Semi-Novo', 18, 'Toyota Prius'),
    ('JN-88-MF', 2023, 'Semi-Novo', 18, 'BMW 320i'),
    ('HO-46-XS', 2020, 'Novo', 24, 'Volkswagen Golf'),
    ('NQ-24-DP', 2021, 'Novo', 24, 'Audi A3'),
    ('XR-98-MF', 2022, 'Semi-Novo', 18, 'Volkswagen Golf'),
    ('CS-16-FS', 2023, 'Novo', 18, 'Audi A3'),
    ('NT-17-PQ', 2020, 'Novo', 24, 'BMW 320i'),
    ('AU-56-LA', 2020, 'Novo', 24, 'Volkswagen Golf'),
    ('AV-68-LA', 2021, 'Semi-Novo', 24, 'Audi A3'),
    ('LX-05-LA', 2022, 'Semi-Novo', 18, 'Volkswagen Golf'),
    ('DY-29-MR', 2023, 'Novo', 18, 'Audi A3'),
    ('SZ-22-SA', 2020, 'Novo', 24, 'Toyota Corolla'),
    ('MA-01-MA', 2021, 'Novo', 24, 'Chevrolet Camaro'),
    ('AB-10-MR', 2022, 'Semi-Novo', 18, 'Ford Mustang'),
    ('BC-70-IO', 2023, 'Semi-Novo', 18, 'Mercedes-Benz C-Class'),
    ('VE-26-OI', 2020, 'Novo', 24, 'Lexus IS'),
    ('EF-85-PS', 2021, 'Novo', 24, 'Nissan Maxima'),
    ('UG-99-PC', 2022, 'Semi-Novo', 18, 'Tesla Model S'),
    ('KH-67-PC', 2023, 'Novo', 18, 'Audi A4'),
    ('AI-45-PC', 2023, 'Novo', 18, 'Porsche 911 GT3 RS'),
    ('FJ-02-LA', 2020, 'Semi-Novo', 24, 'Lamborghini Huracan'),
    ('GK-23-PA', 2021, 'Semi-Novo', 18, 'Audi TT RS');
